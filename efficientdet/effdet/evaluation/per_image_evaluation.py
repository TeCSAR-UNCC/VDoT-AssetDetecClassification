...
'''class PerImageEvaluation:
    ...
    def _compute_cor_loc(
        ...
        (gt_boxes_at_ith_class,
            detected_boxes_at_ith_class, detected_scores_at_ith_class) = self._get_ith_class_arrays(
            detected_boxes, detected_scores,
            detected_class_labels, gt_boxes,
            gt_class_labels)
    ...
    def _compute_tp_fp(
        ...
        #for i in range(self.num_gt_classes):
        gt_is_difficult_list_at_ith_class = (
            gt_is_difficult_list[gt_class_labels])
        gt_is_group_of_list_at_ith_class = (
            gt_is_group_of_list[gt_class_labels])
        (gt_boxes_at_ith_class,
        detected_boxes_at_ith_class, detected_scores_at_ith_class) = self._get_ith_class_arrays(
            detected_boxes, detected_scores,
            detected_class_labels, gt_boxes,
    ...
    def _get_ith_class_arrays(
        ...
        Returns:
            ...
            detected_masks_at_ith_class: A numpy array containing detected masks corresponding to the ith class.
        """
        selected_groundtruth = gt_class_labels
        gt_boxes_at_ith_class = gt_boxes
        #if gt_masks is not None:
            #gt_masks_at_ith_class = gt_masks[selected_groundtruth]
        #else:
            #gt_masks_at_ith_class = None
        selected_detections = detected_class_labels
